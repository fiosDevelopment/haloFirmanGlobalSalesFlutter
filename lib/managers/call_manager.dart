...
import 'package:halo_firman_sales/pages/call/incoming_call_screen.dart';
...
class CallManager {
  ...
  void startNewCall(BuildContext context, int callType, Set<int> opponents,
    ...
    _currentCall = callSession;
    Get.to(() => ConversationCallScreen(callSession, false, name, image));
